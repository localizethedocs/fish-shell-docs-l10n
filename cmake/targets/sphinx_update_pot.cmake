...
find_package(Gettext    MODULE REQUIRED COMPONENTS Xgettext Msgcat Msgmerge)
...
if (CMAKE_HOST_LINUX)
    set(ENV_PATH                "${PROJ_CONDA_DIR}/bin:${PROJ_OUT_REPO_DIR}/build:$ENV{PATH}")
...
message(STATUS "Running 'xgettext' command to update 'sphinx.pot' file from 'conf.py' file...")
set(SPHINX_POT_FILE     "${PROJ_OUT_REPO_DOCS_LOCALE_DIR}/pot/LC_MESSAGES/sphinx.pot")
set(CONF_PY_FILE        "${PROJ_OUT_REPO_DOCS_CONFIG_DIR}/conf.py")
remove_cmake_message_indent()
message("")
update_sphinx_pot_from_conf_py(
    IN_SPHINX_POT_FILE  "${SPHINX_POT_FILE}"
    IN_CONF_PY_FILE     "${CONF_PY_FILE}"
